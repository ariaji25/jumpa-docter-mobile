...
class _OrderApi implements OrderApi {
  ...
  @override
  Future<dynamic> getDoctors(organisationUnitsId) async {
  ...
  @override
  Future<dynamic> getClinicsByArea(areaId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<dynamic> getPriceService(
    period,
    dataSet,
    orgUnit,
  ) async {
  ...
  Future<String> createBooking(data) async {
    ...
    final _result = await _dio.fetch<String>(_setStreamType<String>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/api/events?strategy=CREATE_AND_UPDATE',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  @override
  Future<dynamic> createEnrollment(data) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
