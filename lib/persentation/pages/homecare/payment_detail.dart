...
class _PaymentDetailPageState extends State<PaymentDetailPage> {
  ...
  void makeAppointment(OrderProvider orderProvider) async {
    ...
    if ((orderProvider.makeAppointmentState == RequestState.Loaded && orderProvider.bookingEntities.orderType == AppConst.ORDER_FOR_OTHER) || orderProvider.bookingEntities.orderType != AppConst.ORDER_FOR_OTHER) {
      // Store the booking history in patient
      orderProvider.bookingEntities.teiReference = patientProvider.patient.tei;
