        ...
        child: Column(
          ...
          children: [
            ...
            cardColumn(
              ...
              "${orderProvider.bookingEntities.visitTime} ${DateHelper.getTimezon()} - ${orderProvider.bookingEntities.visitDate != null ? DateHelper.dateTimeToLocalDate(orderProvider.bookingEntities.visitDate)!.replaceAll("-", "/") : ''}",
            ),
            cardColumn(
              "Alamat janji temu",
